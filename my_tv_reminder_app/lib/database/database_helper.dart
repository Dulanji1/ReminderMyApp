...
class DatabaseHelper {
  ...
  //Update
  static updateWishlist(String? name,String? episodeCount,String? tvChanel, String? description, int? id) async {
    return await _database!.rawUpdate(
        '''
             UPDATE wishlist
             SET name = ? AND SET episodeCount = ? And SET tvChanel =? AND SET
             description = ?
             WHERE id =?
             ''', [name, episodeCount, tvChanel,description,  id]
    );
  }
}