...
// view wishlist from database
  ...
  updateWishlist(String? name,String? episodeCount,String? tvChanel, String? description, int? id) async {
    await DatabaseHelper.updateWishlist(name, episodeCount, tvChanel, description, id);
    getWishlist();
  }
